...
// tslint:disable:max-func-body-length no-http-string no-multiline-string max-line-length
...
suite("Utilities", () => {
    ...
    //     test("with null", () => {
    //         assert.equal(false, Utilities.isArmDeploymentSchemaUri(null));
    //     });

    //     test("with undefined", () => {
    //         assert.equal(false, Utilities.isArmDeploymentSchemaUri(undefined));
    //     });

    //     test("with 'hello world'", () => {
    //         assert.equal(false, Utilities.isArmDeploymentSchemaUri("hello world"));
    //     });

    //     test("with 'www.bing.com'", () => {
    //         assert.equal(false, Utilities.isArmDeploymentSchemaUri("www.bing.com"));
    //     });

    //     test("with 'https://schema.management.azure.com/schemas/2015-01-01/deploymentTemplate.json#'", () => {
    //         assert.equal(true, Utilities.isArmDeploymentSchemaUri("https://schema.management.azure.com/schemas/2015-01-01/deploymentTemplate.json#"));
    //     });
    ...
    //         assert.equal(true, Utilities.isArmDeploymentSchemaUri("http://schema.management.azure.com/schemas/2015-01-01/deploymentTemplate.json"));
    //     });
    ...
    //         assert.equal(true, Utilities.isArmDeploymentSchemaUri("https://schema.management.azure.com/schemas/2014-04-01-preview/deploymentTemplate.json#"));
    //     });
    ...
    //         assert.equal(true, Utilities.isArmDeploymentSchemaUri("https://schema.management.azure.com/schemas/2018-05-01/subscriptionDeploymentTemplate.json#"));
    //     });
    ...
    //         assert.equal(true, Utilities.isArmDeploymentSchemaUri("http://schema.management.azure.com/schemas/2018-05-01/subscriptionDeploymentTemplate.json#"));
    //     });
    ...
    //         assert.equal(true, Utilities.isArmDeploymentSchemaUri("http://schema.management.azure.com/schemas/xxxx-yy-zz/subscriptionDeploymentTemplate.json#"));
    //     });
    ...
    //         assert.equal(false, Utilities.isArmDeploymentSchemaUri("http://schema.management.azure.com/schemas/xxxx-yy-zz/SubscriptionDeploymentTemplate.json#"));
    //     });
    // });
});
